<div class="body-wrapper" data-spy="scroll" data-target=".privacy-nav">
    <nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
                ...
                <div class="row">
                    <div class="col-lg-6 ml-auto justify-content-center">
                        ...
                        <div class="image-content" data-aos="fade-right">
                            <img class="img-fluid" src="assets/images/feature/feature-new-01.jpg" alt="iphone">
                        </div>
                    </div>
                        ...
                        <div class="testimonial">
                            ...
                            <ul class="list-inline meta">
                                <li class="list-inline-item">
                                    <img src="assets/images/testimonial/feature-testimonial-thumb.jpg" alt="">
                                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mr-auto justify-content-center">
                        ...
                        <div class="image-content" data-aos="fade-left">
                            <img class="img-fluid" src="assets/images/feature/feature-new-02.jpg" alt="ipad">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row no-gutters">
                    <div class="col-lg-6 align-self-center">
                        ...
                        <div class="service-thumb left" data-aos="fade-right">
                            <img class="img-fluid" src="assets/images/feature/iphone-ipad.jpg" alt="iphone-ipad">
                        </div>
                    </div>
                        ...
                        <div class="testimonial-slider owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="block shadow">
                                    ...
                                    <!-- Person Thumb -->
                                    <div class="image">
                                        <img src="assets/images/testimonial/feature-testimonial-thumb.jpg" alt="image">
                                    </div>
                                    <!-- Name and Company -->
        ...
        <section class="section py-6 pricing-section" id="pricing">
            <div class="container">

                <!-- HEADER -->
                <div class="text-center mb-5">
                    <h1 class="fw-bold display-5">
                        Investasi Terbaik untuk <span class="gradient-text">Masa Depanmu</span>
                    </h1>
                    <p class="text-muted fs-5 mt-3">
                        Pilih paket yang sesuai dan mulai perjalanan belajarmu hari ini 🚀
                    </p>
                </div>
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex">
                        ...
                        <div class="pricing-card-modern 
                            {{ $package['highlight'] ? 'active' : '' }} w-100 d-flex flex-column">
                            ...
                            <div class="flex-grow-1 d-flex flex-column">
                                ...
                                <!-- PRICE -->
                                <div class="text-center price-wrapper my-3">
                                    <h1 class="price-modern">
                                        Rp {{ number_format($billing == 'monthly' ? $package['price_monthly'] : $package['price_yearly']) }}
                                    </h1>
                                ...
                                <!-- BUTTON -->
                                <button 
                                    wire:click="buy('{{ $package['id'] }}')" 
                                    class="btn-modern w-100 mt-3">
                                    {{ $package['button'] }}
                                </button>
        ...
        <div class="footer-main">
            ...
            <div class="row">
                ...
                <div class="block">
                    <a href="index.html"><img src="assets/images/logo-alt.png" alt="footer-logo"></a>
                    <!-- Social Site Icons -->
