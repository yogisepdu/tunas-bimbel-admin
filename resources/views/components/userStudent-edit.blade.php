...
<div class="mb-6">
    ...
    <button type="submit"
        ...
        class="text-white bg-brand hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium rounded-base text-sm px-4 py-2.5 flex items-center gap-2">
